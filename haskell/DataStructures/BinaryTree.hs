...
main :: IO ()
main = do
    let tree = fromList [4, 2, 5, 1, 6, 8]
    print $ preOrder id tree
    print $ inOrder id tree
    print $ posOrder id tree
    print $ contains 8 tree
    print $ preOrder id $ pop 1 tree
    print $ preOrder id $ pop 2 tree
    print $ preOrder id $ pop 3 tree
    print $ size tree
    print $ height tree
    print $ toList tree
    print $ (*4) <$> tree
